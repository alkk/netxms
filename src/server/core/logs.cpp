...
static NXCORE_LOG s_logs[] =
{
   ...
   { _T("WindowsEventLog"), _T("win_event_log"), _T("id"), _T("node_id"), SYSTEM_ACCESS_VIEW_SYSLOG,
	...
	{ _T("NotificationLog"), _T("notification_log"), _T("id"), _T("notification_id"), SYSTEM_ACCESS_VIEW_SYSLOG,
      {
			{ _T("id"), _T("ID"), LC_INTEGER, 0 },
	...
	{ _T("ServerActionExecutionLog"), _T("server_action_execution_log"), _T("id"), _T("server_action_id"), SYSTEM_ACCESS_VIEW_SYSLOG,
      {
			{ _T("id"), _T("ID"), LC_INTEGER, 0 },
